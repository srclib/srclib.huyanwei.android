...
public class DragLayer extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN && Launcher.mAppLaunchTimeLog) {
            Log.i(Launcher.TAG, "[AppLaunch] " + "Launcher TouchEvent Entry Pont: DragLayer.dispatchTouchEvent");
        }
