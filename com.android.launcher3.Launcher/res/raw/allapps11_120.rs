...
draw_home_button()
{
    ...
    y -= 15; // move the house to the edge of the screen as it doesn't fill the texture.
...
void drawFrontGrid(float rowOffset, float p)
{
    ...
    float rowHeight = colWidth + 12.5f;
    ...
    //float ymin = yoff - (3 * rowHeight) - 35;
    float ymin = yoff - (3 * rowHeight) - 35;
    //float gridTop = yoff -3;
    //float gridTop = yoff - (3 * 3 / 5);
    float gridTop = yoff - 1.5;
