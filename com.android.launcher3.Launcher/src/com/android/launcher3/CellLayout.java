...
public class CellLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_FLAG) {
        	Log.d(TAG, "onMeasure heightSpecSize==" + heightSpecSize + " widthSpecSize==" + widthSpecSize);
        }
        ...
        if (mPortrait) {
            ...
            if (DEBUG_FLAG) {
            	Log.d(TAG, "Portrait onMeasure vSpaceLeft==" + vSpaceLeft + " mHeightGap==" + mHeightGap);
            }
        } else {
            ...
            if (DEBUG_FLAG) {
            	Log.d(TAG, "Landscape onMeasure vSpaceLeft==" + vSpaceLeft + " mHeightGap==" + mHeightGap);
            }
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public void setup(int cellWidth, int cellHeight, int widthGap, int heightGap,
            ...
            if (DEBUG_FLAG) {
            	...
            	Log.d(TAG, "setup heightGap==" + heightGap + " height==" + height + " cellHeight==" + cellHeight);
            }
